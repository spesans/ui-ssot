export const ROUTE_LANGUAGES = ["en", "ja"] as const;
export type RouteLanguage = (typeof ROUTE_LANGUAGES)[number];

export const DEFAULT_ROUTE_LANGUAGE: RouteLanguage = "en";
...
export const isRouteLanguage = (value: string | null | undefined): value is RouteLanguage => {
  return !!value && ROUTE_LANGUAGES.includes(value as RouteLanguage);
};
